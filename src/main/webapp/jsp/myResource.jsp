...
<body>
	...
	<div class="page text-center">
		...
		var div = document.getElementById("myResource");
						...
						<div class="cell-sm-3 cell-md-12">
							...
							<div
								...
								<p class="font-accent text-bold text-spacing-50 text-mine-shaft"
									style="margin-top: 30px">搜索我的资源</p>
								...
								<div class="offset-top-25 swiper-scrollbar" style="height: 300px;overflow:auto;">
									<ul
										...
										<li><a href="javascript:void(0)" class="text-primary" onclick="setDate('2017-03-01')" style="font-size: 16px;">2017.03</a></li>
										<li class="offset-top-10"><a href="javascript:void(0)"
																	 class="text-primary" style="font-size: 16px;" onclick="setDate('2017-02-01')">2017.02</a></li>
										<li class="offset-top-10"><a href="javascript:void(0)"
																	 class="text-primary" style="font-size: 16px;" onclick="setDate('2017-01-01')">2017.01</a></li>
										<li class="offset-top-10"><a href="javascript:void(0)"
										...
										<li class="offset-top-10"><a href="javascript:void(0)"
																	 class="text-primary" style="font-size: 16px;" onclick="setDate('2016-09-01')">2016.09</a></li>
										<li class="offset-top-10"><a href="javascript:void(0)"
																	 class="text-primary" style="font-size: 16px;" onclick="setDate('2016-08-01')">2016.08</a></li>
										<li class="offset-top-10"><a href="javascript:void(0)"
																	 class="text-primary" style="font-size: 16px;" onclick="setDate('2016-07-01')">2016.07</a></li>
									</ul>
								</div>
								<div
	...
	<script type="text/javascript">
		...
		var pageTotal = -1; //总页数
		var selectDate = "";
		var userID = ${pageContext.getAttribute("userId")};
        $(function(){
		    pageIndex = 1;
                ...
                success: function (data) {
                    ...
                    if(jsonArray.length == 1){
                        if(searchContent==""&& selectDate=="") {
                            divText = "<div class='offset-top-100' align='center'><h3>您还未上传任何（该类）资源 :(</h3><div><div><br><a class=\"btn btn-xxs btn-round btn-primary\" style=\"color: white\" href=\"${pageContext.request.contextPath}/jsp/uploadFile\">去上传</a></div>";
                        }
                        else{
                            divText = "<div class='offset-top-100' align='center'><h3>没找到您想要的搜索结果 :(</h3><div><div><br><a class=\"btn btn-xxs btn-round btn-primary\" style=\"color: white\" href=\"${pageContext.request.contextPath}/jsp/uploadFile\">去上传</a></div>";
                        }
