						...
						<div class="tags cell-sm-7 cell-md-8  offset-top-20" >
							<div class="text-left" >
								...
								<ul class="list-inline list-tags font-accent text-bold text-spacing-inverse-25">
									...
									<li><a href="${pageContext.request.contextPath}/jsp/collectedPost" class="text-gray-light">论坛帖</a></li>
								...
								<article class="post-classic text-left">
											...
											<div class="unit-body">
												...
												<div class="post-body offset-top-15 offset-md-top-25">
													<div class="cell-xs-8 cell-sm-5" style='margin-top: -55px;'>
														<!-- Post Vacancy-->
														<a href="singleForumpost?forumpostID=${forumpost.forumpostId}"
														   class="post-vacancy">
															<!-- Unit-->
                                  ...
                                  <span class="post-title  reveal-block">
                                    <span class="offset-top-5 font-accent text-bold text-spacing-50 text-uppercase"><span
											class="text-mine-shaft">${forumpost.forumpostTitle}</span>
                                  </span>
                                 </span>
                                 <br>
						...
						<div class="offset-top-10">
							...
							<nav>
								<ul
									...
									<li id="before-pagination" class="text-regular"><a href="collectedPost?page_offset=${pagination.pageOffset-1}"
									...
									<c:forEach var="i" begin="${pagination.beginNumber}" end="${pagination.endNumber}">
										<li id="page${i}"><a href="collectedPost?page_current=${i}"> ${i}</a>
										</li>
									</c:forEach>
									<li id="after-pagination" class="text-regular"><a href="collectedPost?page_offset=${pagination.pageOffset+1}"
