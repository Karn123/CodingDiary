                        ...
                        <div class="tags cell-sm-7 cell-md-8  offset-top-20" >
                            <div class="text-left" >
                                ...
                                <ul class="list-inline list-tags font-accent text-bold text-spacing-inverse-25">
                                    ...
                                    <li><a href="${pageContext.request.contextPath}/jsp/collectedBlog" class="text-gray-light">博客</a></li>
                                    <li><a href="${pageContext.request.contextPath}/jsp/collectedPost" class="text-turquoise">论坛帖</a></li>
                                    <li><a href="${pageContext.request.contextPath}/jsp/collectedResource" class="text-turquoise">学习资源</a></li>
                                </ul>
                            </div>
                        </div>
                                ...
                                <article class="post-classic text-left">
                                  ...
                                  <span class="post-title  reveal-block">
                                    <span class="offset-top-5 font-accent text-bold text-spacing-50 text-uppercase"><span
                                            class="text-mine-shaft">${blog.blogTitle}</span>
                                  </span>
                                 </span>
                                 <br>
                        ...
                        <div class="offset-top-10">
                            ...
                            <nav>
                                <ul
                                    ...
                                    <li id="before-pagination" class="text-regular"><a href="collectedBlog?page_offset=${pagination.pageOffset-1}"
                                    ...
                                    <c:forEach var="i" begin="${pagination.beginNumber}" end="${pagination.endNumber}">
                                        <li id="page${i}"><a href="collectedBlog?page_current=${i}"> ${i}</a>
                                        </li>
                                    </c:forEach>
                                    <li id="after-pagination" class="text-regular"><a href="collectedBlog?page_offset=${pagination.pageOffset+1}"
