        ...
        <div class="range range-xs-center range-lg-center">
          <div class="cell-xs-8 cell-sm-7 text-left">
            ...
            <div class="text-center text-sm-right offset-top-60">
              <button type="button" class="btn btn-sm btn-primary" onclick="postForumpost()">提交</button>
            </div>
          </div>
        </div>
      </div>
...
<script type="text/javascript">
    function singleForumpost() {
        window.location.href="singleForumpost?forumpostID=56";
    }
</script>
...
<script type="text/javascript">
    function postForumpost() {
        ...
        var title = document.getElementById("forumpost-title").value;
        var content = $('#customized-buttonpane').trumbowyg('html');
        if (title == "") {
            $("#file_error").empty().append("帖子标题不能为空哦0.0");
            return;
        }
        if (tags_str == "") {
        ...
        $.ajax({
            ...
            data: {
                "forumpost_title": title,
                "forumpost_content": content,
                "forumpost_tags": tags_str
            },
            ...
            success: function (data) {
                if (data.msg =="notLogIn") {
                    ...
                    window.location.href="singleForumpost?forumpostID="+data.retCode;
                }
