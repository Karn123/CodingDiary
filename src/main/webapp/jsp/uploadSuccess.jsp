...
<div class="page text-center">
    ...
    <main class="page-content section-75 section-md-top-90 section-md-bottom-110">
        ...
        <section>
            <div class="shell">
                <div>
                    <h1 id="successTheme"></h1>
                </div>
                <div class="offset-top-25">
                    <p ><div id="successMsg" style="color:black"></div></p>
                </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        retcode = ${retcode};
        if(retcode == "0"){
            $("#successTheme").empty().append("警告！");
            $("#successMsg").empty().append("该文件您曾经上传过啦！请选择其他文件上传吧~");
        }
        //retcode = "1"
        else{
            $("#successTheme").empty().append("上传成功！");
            $("#successMsg").empty().append("您的文件已成功上传，谢谢您的分享！");
        }
    });
</script>
</body>
