...
<div class="page text-center">
    ...
    <script type="text/javascript">
        var div = document.getElementById("otherForumpost");
                                ...
                                <ul id="pageList" class="list-marked list-marked-type-2 list-marked-type-2-dot-1 list-marked-silver-chalice pagination-classic">
                                    <c:if test="${pagination.beginNumber>1}">
                                        <li id="before-pagination" class="text-regular">
                                            <a href="${pageContext.request.contextPath}/jsp/searchOtherForumposts?search_key=${searchType.tagsString}&page_current=${pagination.pageOffset-1}" class="icon icon-sm icon-primary material-icons-ico material-icons-chevron_left"></a>
                                            <span>...</span>
                                        </li>
                                    </c:if>
                                    <c:if test="${pagination.beginNumber==1}">
                                    ...
                                    <c:forEach var="i" begin="${pagination.beginNumber}" end="${pagination.endNumber}">
                                        <li id="page${i}"><a href="${pageContext.request.contextPath}/jsp/searchOtherForumposts?search_key=${searchType.tagsString}&page_current=${i}"> ${i}</a>
                                        </li>
                                    </c:forEach>

                                    <c:if test="${pagination.endNumber<pagination.totalPageNumber}">
                                        <li id="after-pagination" class="text-regular">
                                            <span>...</span><a href="${pageContext.request.contextPath}/jsp/searchOtherForumposts?search_key=${searchType.tagsString}&page_current=${pagination.pageOffset+1}"
                                    ...
                                    <c:if test="${pagination.endNumber >= pagination.totalPageNumber}">
                                        <li id="after-pagination" class="text-regular"><a
                                                href="${pageContext.request.contextPath}/jsp/searchOtherForumposts?search_key=${searchType.tagsString}&page_current=${pagination.pageOffset+1}"
                                                class="icon icon-sm icon-primary material-icons-ico material-icons-chevron_right"></a>
                                        </li>
                                    </c:if>
                                </ul>
                            ...
                            <div class="cell-sm-3 cell-md-12">
                                ...
                                <div class="cell-sm-10 cell-md-4 cell-lg-3 text-sm-left offset-top-64 offset-md-top-0">
                                    ...
                                    <div class="offset-top-5">
                                        <!-- RD Search Form-->
                                        <form action="${pageContext.request.contextPath}/jsp/searchOtherForumposts"
                                    ...
                                    <div class="offset-top-25">
                                        <ul class="list-marked text-extra-small text-bold p text-left font-accent">
                                            <li><a href="${pageContext.request.contextPath}/jsp/searchOtherForumposts?searchBySpecificDate=2017-03-01" class="text-primary"
                                                   style="font-size: 16px;">2017.3</a></li>
                                            <li class="offset-top-10"><a href="${pageContext.request.contextPath}/jsp/searchOtherForumposts?this_id=${sessionScope.get("this_id")}&searchBySpecificDate=2017-02-01" class="text-primary"
                                                                         style="font-size: 16px;">2017.2</a></li>
                                            <li class="offset-top-10"><a href="${pageContext.request.contextPath}/jsp/searchOtherForumposts?this_id=${sessionScope.get("this_id")}&searchBySpecificDate=2017-01-01" class="text-primary"
                                                                         style="font-size: 16px;">2017.1</a></li>
                                            <li class="offset-top-10"><a href="${pageContext.request.contextPath}/jsp/searchOtherForumposts?this_id=${sessionScope.get("this_id")}&searchBySpecificDate=2016-12-01" class="text-primary"
                                                                         style="font-size: 16px;">2016.12</a></li>
                                            <li class="offset-top-10"><a href="${pageContext.request.contextPath}/jsp/searchOtherForumposts?this_id=${sessionScope.get("this_id")}&searchBySpecificDate=2016-11-01" class="text-primary"
                                    ...
                                    <div class="offset-top-20">
                                        ...
                                        <ul class="list-inline list-tags font-accent text-bold text-spacing-inverse-25 text-left">
                                            <li><a class="text-turquoise"
                                                   href="${pageContext.request.contextPath}/jsp/searchOtherForumposts?this_id=${sessionScope.get("this_id")}&search_key=JAVA">JAVA</a>
                                            </li>
                                            <li><a class="text-turquoise"
                                                   href="${pageContext.request.contextPath}/jsp/searchOtherForumposts?this_id=${sessionScope.get("this_id")}&search_key=Csh">C#</a>
                                            </li>
                                            <li><a class="text-turquoise"
                                                   href="${pageContext.request.contextPath}/jsp/searchOtherForumposts?this_id=${sessionScope.get("this_id")}&search_key=.NET">.NET</a>
                                            </li>
                                            <li><a class="text-turquoise"
                                                   href="${pageContext.request.contextPath}/jsp/searchOtherForumposts?this_id=${sessionScope.get("this_id")}&search_key=CPP">C++</a>
                                            </li>
                                            <li><a class="text-turquoise"
                                                   href="${pageContext.request.contextPath}/jsp/searchOtherForumposts?this_id=${sessionScope.get("this_id")}&search_key=PHP">PHP</a>
                                            </li>
                                            <li><a class="text-turquoise"
                                                   href="${pageContext.request.contextPath}/jsp/searchOtherForumposts?this_id=${sessionScope.get("this_id")}&search_key=CSS">CSS</a>
                                            </li>
                                            <li><a class="text-turquoise"
                                                   href="${pageContext.request.contextPath}/jsp/searchOtherForumposts?this_id=${sessionScope.get("this_id")}&search_key=HTML">HTML</a>
                                            </li>
                                            <li><a class="text-turquoise"
                                                   href="${pageContext.request.contextPath}/jsp/searchOtherForumposts?this_id=${sessionScope.get("this_id")}&search_key=IOS">IOS</a>
                                            </li>
                                            <li><a class="text-turquoise"
                                                   href="${pageContext.request.contextPath}/jsp/searchOtherForumposts?this_id=${sessionScope.get("this_id")}&search_key=Javascript">Javascript</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="veil-sm reveal-md-block offset-top-30 offset-sm-top-0 offset-md-top-30">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        if(totalPageNum=="0"){
            var divText = "<div class='offset-top-100' align='center'><h3>TA还未发表任何（该类）论坛帖 :(</h3><div>";
            $("#loadForumpostDiv").empty().append(divText);
            $("#pageList").empty();
        }
    });
</script>
