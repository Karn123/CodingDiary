 ...
 */
@Entity
@Table(name = "resource_recommend", schema = "CodingDiaryDB", catalog = "")
@IdClass(ResourceRecommendEntityPK.class)
public class ResourceRecommendEntity {
    private int tagId;
    ...
    public boolean equals(Object o) {
        ...
        ResourceRecommendEntity that = (ResourceRecommendEntity) o;
