 ...
 */
@Entity
@Table(name = "forumpost_recommend_new", schema = "CodingDiaryDB", catalog = "")
@IdClass(ForumpostRecommendNewEntityPK.class)
public class ForumpostRecommendNewEntity {
    private int tagId;
    ...
    public boolean equals(Object o) {
        ...
        ForumpostRecommendNewEntity that = (ForumpostRecommendNewEntity) o;
