 ...
 */
@Entity
@Table(name = "blog_recommend_new", schema = "CodingDiaryDB", catalog = "")
@IdClass(BlogRecommendNewEntityPK.class)
public class BlogRecommendNewEntity {
    private int tagId;
    ...
    public boolean equals(Object o) {
        ...
        BlogRecommendNewEntity that = (BlogRecommendNewEntity) o;
